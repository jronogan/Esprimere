    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          {activeTab === "schedule" && <ScheduleTab classSlots={classSlots} />}
          {activeTab === "packages" && <PackagesTab passPackages={passPackages} />}
          {activeTab === "availability" && (
            <AvailabilityTab availabilities={availabilities} rooms={rooms} />
          )}
